--[[
    Script: Workspace.meanspyrobot.Animate
    Type: LocalScript
...
game:GetService("Players").LocalPlayer.Chatted:connect(function(v90) --[[ Line: 540 ]]
...
script:WaitForChild("PlayEmote").OnInvoke = function(v92) --[[ Line: 557 ]]
