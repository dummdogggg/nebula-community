...
local any_New_result1_upvr_4 = Remote.New("ReplicaSignal")
local any_New_result1_upvr_5 = Remote.New("ReplicaSignalUnreliable", true)
...
local tbl_25_upvr = {}
tbl_25_upvr.__index = tbl_25_upvr
local var444_upvw
...
function ConnectionNew(arg1, arg2) -- Line 203
	...
	tbl_34.t = arg1
	tbl_34.fn = arg2
	local setmetatable_result1_4 = setmetatable(tbl_34, tbl_25_upvr)
...
function tbl_25_upvr.Disconnect(arg1) -- Line 223
	arg1.t[arg1] = nil
end
local module_3_upvr = {
	IsReady = false;
...
local function ReplicaNew_upvr(arg1, arg2) -- Line 233, Named "ReplicaNew"
	...
	tbl_28.Id = arg1
	tbl_28.Token = arg2[1]
	tbl_28.Parent = var450
	tbl_28.Children = {}
	tbl_28.BoundInstance = nil
	tbl_28.OnClientEvent = Signal_upvr.New()
	tbl_28.Maid = Maid_upvr_2.New(tbl_4_upvr)
	tbl_28.self_creation = arg2
	tbl_28.write_lib = var449
	tbl_28.set_listeners = {}
	tbl_28.write_listeners = {}
	tbl_28.changed_listeners = {}
	local setmetatable_result1_2 = setmetatable(tbl_28, module_3_upvr)
	if var450 ~= nil then
...
function module_3_upvr.OnNew(arg1, arg2) -- Line 295
	...
	local var459 = tbl_31_upvr[arg1]
	if var459 == nil then
		var459 = {}
		tbl_31_upvr[arg1] = var459
	end
...
function module_3_upvr.Test() -- Line 326
	...
	return {
		...
		BindReplicas = tbl_21_upvr;
		BindInstances = tbl_32_upvr;
	}
end
...
function module_3_upvr.FireServer(arg1, ...) -- Line 372
	...
	any_New_result1_upvr_4:FireServer(arg1.Id, ...)
end
...
local function DestroyReplica_upvr(arg1, arg2) -- Line 527, Named "DestroyReplica"
	...
	if tbl_13_upvr[Id_2] == arg1 then
		tbl_13_upvr[Id_2] = nil
	end
	if tbl_21_upvr[Id_2] == arg1 then
		tbl_21_upvr[Id_2] = nil
	end
...
local function ReplicaToBindBuffer_upvr(arg1, arg2) -- Line 559, Named "ReplicaToBindBuffer"
	...
	tbl_21_upvr[arg1.Id] = ReplicaNew_upvr_result1_2
...
local function ReplicaFromBindBuffer_upvr(arg1, arg2) -- Line 580, Named "ReplicaFromBindBuffer"
	...
	if true == true then
		for _, v_9 in ipairs(var599) do
			local var608 = tbl_31_upvr[v_9.Token]
			if var608 ~= nil then
...
local function BreadthCreationSort_upvr(arg1, arg2, arg3) -- Line 637, Named "BreadthCreationSort"
	...
	for _, v_11 in ipairs_result1_7, var662, ipairs_result3_2 do
		for i_24, v_12 in pairs(v_11) do
			...
			local _4_5 = v_12[4]
			if _4_5 == 0 or tbl_29.Id == arg2 then
				table.insert(tbl_18, tbl_29)
			elseif v_11[tostring(_4_5)] ~= nil then
				...
				table.insert(var668, tbl_29)
			else
				table.insert(tbl_3, tbl_29)
			end
		end
	end
	var662 = tbl_18
	...
	local ipairs_result1_3, ipairs_result2, ipairs_result3_6 = ipairs(tbl_18)
	for i_25, v_13 in ipairs_result1_3, ipairs_result2, ipairs_result3_6 do
...
Remote.New("ReplicaSetValues").OnClientEvent:Connect(function(arg1, arg2, arg3) -- Line 761
	...
	local var689 = var688
	var410_upvw = true
	local pcall_result1_6, pcall_result2_6 = pcall(var689.SetValues, var689, arg2, arg3)
	var410_upvw = false
...
Remote.New("ReplicaTableInsert").OnClientEvent:Connect(function(arg1, arg2, arg3, arg4) -- Line 771
	...
	local var694 = var693
	var410_upvw = true
	local pcall_result1_4, pcall_result2_5 = pcall(var694.TableInsert, var694, arg2, arg3, arg4)
	var410_upvw = false
...
Remote.New("ReplicaTableRemove").OnClientEvent:Connect(function(arg1, arg2, arg3) -- Line 781
	...
	local var699 = var698
	var410_upvw = true
	local pcall_result1_8, pcall_result2_9 = pcall(var699.TableRemove, var699, arg2, arg3)
	var410_upvw = false
	if pcall_result1_8 ~= true then
		error(`[{script.Name}]: Error while updating replica:\n{var699:Identify()}\n`..pcall_result2_9)
	end
end)
Remote.New("ReplicaWrite").OnClientEvent:Connect(function(arg1, arg2, ...) -- Line 791
	...
	local var704 = var703
	var410_upvw = true
	local pcall_result1_7, pcall_result2_7 = pcall(var704.Write, var704, var704.write_lib[arg2].Name, ...)
	var410_upvw = false
...
any_New_result1_upvr_4.OnClientEvent:Connect(RemoteSignalHandle)
...
Remote.New("ReplicaParent").OnClientEvent:Connect(function(arg1, arg2) -- Line 810
	...
	if tbl_21_upvr[Parent_3.Id] ~= nil and tbl_13_upvr[arg2] ~= nil then
		ReplicaFromBindBuffer_upvr(var710)
	elseif tbl_13_upvr[Parent_3.Id] ~= nil and tbl_21_upvr[arg2] ~= nil then
...
Remote.New("ReplicaCreate").OnClientEvent:Connect(function(arg1, arg2) -- Line 831
	...
	BreadthCreationSort_upvr(arg1, arg2, function(arg1_9, arg2_7) -- Line 835
		--[[ Upvalues[6]:
			...
			[2]: tbl_32_upvr (copied, readonly)
			[3]: tbl_21_upvr (copied, readonly)
		...
		if _4_2 == 0 then
			if ReplicaNew_upvr_result1.Tags.Bind == true then
				local var723 = tbl_32_upvr[arg1_9]
		...
		elseif tbl_21_upvr[_4_2] ~= nil then
			var722 = true
		end
		if var722 == true then
			tbl_21_upvr[arg1_9] = ReplicaNew_upvr_result1
		else
	...
	for _, v_15 in ipairs(tbl_15_upvr) do
		local var729 = tbl_31_upvr[v_15.Token]
		if var729 ~= nil then
...
local function _(arg1) -- Line 913, Named "OnBindInstanceAdded"
	...
	tbl_32_upvr[Value_9] = Parent_4
	local var741 = tbl_21_upvr[Value_9]
	if var741 ~= nil then
...
CollectionService_2:GetInstanceAddedSignal("REPLICA"):Connect(function(arg1) -- Line 941
	...
	if arg1:IsA("NumberValue") == true then
		...
		tbl_32_upvr[Value_7] = Parent
		local var747 = tbl_21_upvr[Value_7]
		if var747 ~= nil then
...
for _, v_16 in pairs(CollectionService_2:GetTagged("REPLICA")) do
	if v_16:IsA("NumberValue") == true then
		...
		tbl_32_upvr[Value_4] = Parent_2
		local var756 = tbl_21_upvr[Value_4]
		if var756 ~= nil then
