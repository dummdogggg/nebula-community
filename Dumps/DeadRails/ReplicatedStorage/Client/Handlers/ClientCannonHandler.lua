...
local l_CannonStart_0 = l_ReplicatedStorage_0.Remotes.CannonStart;
...
l_CannonStart_0.OnClientEvent:Connect(function(v19, v20) --[[ Line: 35 ]]
    ...
    if v19 then
        ...
        v8 = l_RunService_0.RenderStepped:Connect(function() --[[ Line: 56 ]]
            ...
            local l_Position_0 = v20.PivotPoint.Position;
            ...
            v31 = math.clamp(v31, -0.7853981633974483, 0.7853981633974483);
            v32 = math.clamp(v32, -0.7853981633974483, 0.7853981633974483);
            local v33 = CFrame.new(l_Position_0) * CFrame.Angles(0, -v31, 0) * CFrame.Angles(0, math.rad(v20.VehicleSeat.Orientation.Y), 0) * CFrame.Angles(v32 + 0.22689280275926285, 0, 0);
            local l_Motor6D_0 = v20.Mount.Motor6D;
            local l_Motor6D_1 = v20.Mount.Motor6D;
            local l_Part0_1 = l_Motor6D_1.Part0;
            local l_C0_1 = l_Motor6D_1.C0;
            l_Motor6D_0.C1 = v33:Inverse() * l_Part0_1.CFrame * l_C0_1;
            l_Motor6D_0 = workspace:Raycast(v20.Cannon.FirePoint.WorldPosition, v20.Cannon.FirePoint.WorldCFrame.LookVector * 1000, v22);
            local v38 = nil;
            if l_Motor6D_0 then
                ...
                l_Motor6D_1, l_Part0_1 = l_CurrentCamera_0:WorldToScreenPoint(v20.Cannon.FirePoint.WorldPosition + v20.Cannon.FirePoint.WorldCFrame.LookVector * 1000);
                v38 = l_Motor6D_1;
            ...
            if v20.ClosestAmmo.Value then
                ...
                l_LocalPlayer_0.PlayerGui.TurretGui.Ammo.Text = "No Cannon Ammo nearby";
            end;
            l_C0_1 = workspace:GetServerTimeNow() - l_workspace_ServerTimeNow_0 < l_Value_0 - 0.05;
            if v9 and not l_C0_1 then
                v20.Shoot:FireServer(v20.Cannon.FirePoint.WorldPosition, v20.Cannon.FirePoint.WorldCFrame.LookVector);
                l_workspace_ServerTimeNow_0 = workspace:GetServerTimeNow();
            end;
        end);
        return;
    else
        local _ = v20.PivotPoint.Position;
        v20.Mount.Motor6D.C1 = CFrame.Angles(0, 0, 1.5707963267948966);
