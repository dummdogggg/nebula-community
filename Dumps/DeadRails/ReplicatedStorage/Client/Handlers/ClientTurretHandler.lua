...
-- Decompiled on 2025-03-29 09:46:14
-- Luau version 6, Types version 3
-- Time taken: 0.003058 seconds
...
ReplicatedStorage.Remotes.TurretStart.OnClientEvent:Connect(function(arg1, arg2) -- Line 35
	--[[ Upvalues[8]:
	...
	if arg1 then
		...
		var5_upvw = RunService_upvr.RenderStepped:Connect(function() -- Line 56
			...
			local Position = arg2.Gun.PivotPoint.Position
			...
			var18 = 0
			var18 = arg2.Tripod
			local Motor6D = var18.Base.Motor6D
			var18 = Motor6D.C0
			arg2.Tripod.Base.Motor6D.C1 = CFrame.new(Position) * CFrame.Angles(var18, -math.clamp(math.atan2(Unit_2:Dot(Unit), Unit_2:Dot(LookVector)), (-math.pi/2), (math.pi/2)), 0) * CFrame.Angles(0, var18, 0) * CFrame.Angles(math.clamp(math.asin(Unit_2:Dot(Unit:Cross(LookVector).Unit)), (-math.pi/2), (math.pi/2)), 0, var18):Inverse() * Motor6D.Part0.CFrame * var18
			var18 = arg2.Gun.FirePoint
			var18 = arg2.Gun.FirePoint.Attachment.WorldCFrame.LookVector
			var18 = RaycastParams_new_result1_upvr
			local workspace_Raycast_result1 = workspace:Raycast(var18.Attachment.WorldPosition, var18 * 1000, var18)
			local var22
			if workspace_Raycast_result1 then
				...
				any_WorldToScreenPoint_result2 = arg2.Gun.FirePoint.Attachment.WorldPosition + arg2.Gun.FirePoint.Attachment.WorldCFrame.LookVector * 1000
			...
			if any_WorldToScreenPoint_result2.ClosestAmmo.Value then
				...
				any_WorldToScreenPoint_result2 = LocalPlayer_upvr.PlayerGui.TurretGui
				any_WorldToScreenPoint_result2 = "No Turret Ammo nearby"
				any_WorldToScreenPoint_result2.Ammo.Text = any_WorldToScreenPoint_result2
			end
			...
			if var3_upvw and not any_WorldToScreenPoint_result2 then
				arg2.Shoot:FireServer(arg2.Gun.FirePoint.Attachment.WorldPosition, arg2.Gun.FirePoint.Attachment.WorldCFrame.LookVector)
				workspace_GetServerTimeNow_result1_upvw = workspace:GetServerTimeNow()
			end
		end)
	else
		RaycastParams_new_result1_upvr = arg2.Gun.PivotPoint.Position
		arg2.Tripod.Base.Motor6D.C1 = CFrame.Angles(0, (-math.pi), (math.pi/2))
