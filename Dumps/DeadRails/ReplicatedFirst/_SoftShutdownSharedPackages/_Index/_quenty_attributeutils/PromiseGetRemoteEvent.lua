--[[
    Script: ReplicatedFirst._SoftShutdownSharedPackages._Index.@quenty/attributeutils.PromiseGetRemoteEvent
    Type: ModuleScript
...
return function(arg1) -- Line 33
	...
	if ReplicatedStorage_upvr:FindFirstChild(var1_result1_upvr_3.REMOTE_EVENT_STORAGE_NAME) then
		var13 = ReplicatedStorage_upvr:FindFirstChild(var1_result1_upvr_3.REMOTE_EVENT_STORAGE_NAME):FindFirstChild(arg1)
		if var13 then
			return var1_result1_upvr.resolved(var13)
		end
	end
	var13 = var1_result1_upvr.spawn
	var13 = var13(function(arg1_3, arg2) -- Line 44
		--[[ Upvalues[2]:
